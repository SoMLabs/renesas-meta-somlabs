...
then
        ...
        then
                ...
                media-ctl -d /dev/media0 -V "'$camera':0 [fmt:UYVY8_2X8/$ov5640_res field:none]"
                echo "Link CRU/CSI2 to $camera with format UYVY8_2X8 and resolution $ov5640_res"
        fi
fi
